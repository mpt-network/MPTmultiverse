...
In this example, convergence failed for the no-pooling maximum-likelihood approach.
A possible means to resolve this issue could be increasing the number of optimization runs, which can be done by typing `mpt_options(n.iter = 40)` and re-run.
